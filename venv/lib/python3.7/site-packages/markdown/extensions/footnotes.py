...
class FootnoteExtension(Extension):
    ...
    def extendMarkdown(self, md):
        ...
        md.inlinePatterns.register(FootnoteInlineProcessor(
            FOOTNOTE_RE, self), 'footnote', 175)
    ...
    def unique_ref(self, reference, found=False):
        ...
        while reference in self.used_refs:
            ...
            if m:
                reference = '%s%d%s%s' % (m.group(1), int(
                    m.group(2))+1, self.get_separator(), rest)
            else:
